...
//    [self.view insertSubview:self.customNavBar aboveSubview:self.baseSearchTableView];
}
...
- (UITableView *)baseSearchTableView
{
    if (!_baseSearchTableView) {
        UITableView *baseSearchTableView = [[UITableView alloc] initWithFrame:(CGRect){0, NAV_HEIGHT, kScreenWidth, kScreenHeight - NAV_HEIGHT} style:UITableViewStyleGrouped];
