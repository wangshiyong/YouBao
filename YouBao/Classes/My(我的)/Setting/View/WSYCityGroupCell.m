...
@implementation WSYCityGroupCell
...
//    [self.noDataLabel setHidden:(cityArray != nil && cityArray.count > 0)];
    ...
    for (int i = 0; i < cityArray.count; i ++) {
        WSYCityModel *city = [cityArray objectAtIndex:i];
        UIButton *button = nil;
...
{
    WSYCityModel *city = [self.cityArray objectAtIndex:sender.tag];
